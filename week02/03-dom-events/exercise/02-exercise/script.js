...
var textarea = function getElemArrayByClassName(className) {
...
console.log(getElemArrayByClassName);

/*var textarea = document.getElementById("gettyburry").value;
...
ocument.getElementsByTagName('TEXTAREA')[0].addEventListener('input', function(e) {
    var targ = e.target;
